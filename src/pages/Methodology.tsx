  ...
  return (
    <Layout>
      <section className="py-12 md:py-20"><div className="container-wide">
        <h1 className="text-display mb-4">Methodology & Sources</h1>
        <p className="text-body-lg text-muted-foreground max-w-3xl mb-4">Complete source catalog and data quality information.</p>
        <div className="flex gap-4 text-sm text-muted-foreground">
          <span>Last updated: {data.metadata.last_updated}</span>
          <span>•</span>
      ...
      <section className="py-8"><div className="container-wide">
        <h2 className="section-header">Source Catalog</h2>
        <div className="grid md:grid-cols-2 gap-4">
          {Object.entries(data.source_catalog).map(([id, source]) => (
            <div key={id} className="glass-card p-5">
              ...
              <p className="text-xs text-muted-foreground/60 mt-2 font-mono">ID: {id}</p>
            </div>
          ))}
        </div>
      </div></section>
      ...
      <section className="py-8 bg-muted/30"><div className="container-wide">
        <h2 className="section-header">Data Quality</h2>
        <div className="grid md:grid-cols-2 gap-6">
          <div className="glass-card p-6">
            <h3 className="font-semibold mb-4">Reliability Ratings</h3>
            <div className="space-y-3">
              <div className="flex justify-between"><span>Official Data</span><span className="chip-insight">{data.data_quality_notes.official_data_reliability}</span></div>
              <div className="flex justify-between"><span>Wealth Estimates</span><span className="chip-neutral">{data.data_quality_notes.wealth_estimate_reliability}</span></div>
            </div>
          </div>
          <div className="glass-card p-6">
            <h3 className="font-semibold mb-4">Known Limitations</h3>
